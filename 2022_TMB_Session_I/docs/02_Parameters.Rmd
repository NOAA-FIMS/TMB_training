...
\vdots\\
\frac{exp^{\eta_{k-1}}}{1 + \sum^{k-1}_{i=1}exp^{\eta_{k-1}}}\\
\frac{1}{1 + \sum^{k-1}_{i=1}exp^{\eta_{k-1}}}
\end{bmatrix}
]  
...
---
# Likelihood Ratio Test example and parameter mapping
<br>
...
Pars <- list(beta = c(0.5,2),lnSigma = 0)
